    ...
    DateTimeOffset UpdatedAtUtc)
{
    public static CandidateProfileDto FromDomain(CandidateProfile profile)
    {
        return new CandidateProfileDto(
            ...
            profile.LocationPreference.GetTargetTimezones(),
            profile.LocationPreference.IsWillingToRelocate,
            profile.Preferences.GetExcludedWorkModes(),
            profile.Preferences.GetIncludedCompanyKeywords(),
            profile.Preferences.GetExcludedCompanyKeywords(),
